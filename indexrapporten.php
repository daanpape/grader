...
$app->get('/api/worksheetassess/:worksheetid/:worksheetname/:userid', function($workid, $workname, $userid) use ($app) {
    $app->render('templatesrapport/worksheetassess.php', array('workid' => $workid, 'workname' => $workname, 'userid' => $userid));
});
