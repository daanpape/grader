...
<!-- Header container -->
<div class="container">
    <h1 class="page-header" id="projectHeader" data-value="<?php echo $projectid ?>, text: projectRules">Project Rules</h1>
</div>
            ...
            <table class="table table-striped">
                ...
                <tbody data-bind="foreach: projectRules">
                    <tr>
                        ...
                        <td>
                            <div>
                                <span data-bind="text: ruleTotalScore">Total score:</span>
                                ...
                                <button class="btn deleteRuleBtn form-next"  data-bind="click: removeThisRule, text: deleteRuleName">
                                    Remove this rule
                                </button>
                            </div>
                        </td>
