            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-bind="attr:{'href': '/api/worksheet/' + tworkid + '/' + tname + '/' + viewModel.currentCourseId}"><span class="glyphicon glyphicon-pencil glyphicon-btn" data-bind="attr:{'id': 'editbtn-' + tworkid}"></span></a>
