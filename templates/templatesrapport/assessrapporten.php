        ...
        <div class="container">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a data-bind="attr:{'href': '/api/worksheetassess/' + tworkid + '/' + tname + '/' + viewModel.currentCourseId + '/' + viewModel.currentStudentId}"><span class="glyphicon glyphicon-check glyphicon-btn" data-bind="attr:{'id': 'assessbtn-' + tworkid}"></span></a>
