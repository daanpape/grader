    ...
    <body>
        ...
        <div id="addGroupForm" class="container">
            <div class="row">
                ...
                <input id=studenten type="radio" name="studenten" value="studentlist">All students of studentlist<br>
                <input id=studenten type="radio" name="studenten" value="student">Only the student selected<br>
