<?php
    // Page initialisation
    $location = "jsrapport/adminrapporten";
?>
<!DOCTYPE html>
                ...
                <tbody data-bind="foreach: tabledata">
                    <tr>
                        ...
                        <td>
                            ...
                            <a data-bind="attr:{'href': '/coursecompetence/' + tid}"><span class="glyphicon glyphicon-plus glyphicon-btn" data-bind="attr:{'id': 'managebtn-' + tid}"></span></a>
