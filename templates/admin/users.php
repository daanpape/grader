...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            ...
            <div class="col-lg-1">
                <a href="adduser.php" type="button" class="btn btn-default pagination-button" id="addProjectTypeBtn">
            ...
            <table class="table table-striped">
                ...
                <tbody data-bind="foreach: users">
                    <tr style="width: 100%">
                        ...
                        <!-- ko if: status() === 'ACTIVE' -->
                        <td style="width: 15%" data-bind="if:status"><i class="fa fa-toggle-on fa-lg"></i> <i class="fa fa-times fa-lg" data-bind="click: removeThisUser"></i></td>
                        <!-- /ko -->
                        <!-- ko if: status() !== 'ACTIVE' -->
                        <td style="width: 15%" data-bind="if:status"><i class="fa fa-toggle-off fa-lg"></i> <i class="fa fa-times fa-lg" data-bind="click: removeThisUser"></i></td>
                        <!-- /ko -->
