                                ...
                                <div class="panel-body">
                                    <ul class="list-group" data-bind="foreach: indicators">
                                        ...
                                        <div class="dropdown" style="margin-top:5px">
                                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="color:black; background-color:rgb(240,240,240); border-color:none">Type<span class="caret"></span></button>
