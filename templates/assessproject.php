        ...
        <div class="col-md-12">
            <table class="table table-striped">
                <tr>
                    ...
                    <td style="display:inline-block"><p style="display:inline-block" data-bind="text: totalCompleted"></p><p style="display:inline-block; margin-left: 2px; margin-right: 2px">/</p><p style="display:inline-block" data-bind="text: totalStudents"></p></p></td>
                </tr>
            </table>
        </div>
    </div>
