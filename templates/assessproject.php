        ...
        <div id="top-col" class="col-md-12">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><a data-bind="attr:{'href': '/assess/project/' + tpid + '/student/' + tid + '/scores'}"><button  class="btn btn-default"><span class="glyphicon glyphicon-edit"> </span><span data-bind="text: tScoreTableBtn"></span></button></a></td>
