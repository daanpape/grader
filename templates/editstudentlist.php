...
<!-- Header container -->
<div class="container">
    <h1 class="page-header" id="page-header" data-bind="attr{'data-value': <?php console.log("test"); echo $studentlistid?>}"><span data-bind="text: pageHeader">List: </span><span data-bind="text: studentlistName">Name</span></h1>
</div>
