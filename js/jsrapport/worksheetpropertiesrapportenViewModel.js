...
function pageViewModel(gvm) {
        ...
        $.getJSON('/api/coursestructure/' + courseid, function(data) {
            if (!$.isEmptyObject(data)) {
                ...
                $.each(data, function(i, item) {
                    ...
                    if (item.doelstellingen[Object.keys(item.doelstellingen)[0]] !== undefined) {
                        console.log(item.doelstellingen[Object.keys(item.doelstellingen)[0]]);
    ...
    gvm.updateCompetences = function(data, competences) {          
        $.each(data, function(i, item) {
            ...
            if (item.criterias[Object.keys(item.criterias)[0]] !== undefined) {
                console.log(item.criterias[Object.keys(item.criterias)[0]]);
