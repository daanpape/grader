function pageViewModel(gvm) {
    ...
    gvm.changePermissions = ko.computed(function(){i18n.setLocale(gvm.lang()); return gvm.app() + ' - ' + i18n.__("ChangePermissions");}, gvm);
    gvm.changeUsers = ko.computed(function(){i18n.setLocale(gvm.lang()); return i18n.__("ChangeUsers");}, gvm);

    gvm.dashboard = ko.computed(function(){i18n.setLocale(gvm.lang()); return gvm.app() + ' - ' + i18n.__("AdminDashboard");}, gvm);
