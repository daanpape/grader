...
");
 ...
 SELECT  (select name from module_rapport where course=:id) as name,( select description from module_rapport where course=:id) as description, (select id from course_rapport ORDER BY id DESC LIMIT     1  ) AS course"
);
